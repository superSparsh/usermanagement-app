...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="edit" action="{{ route('admin.update', $admin->id) }}" method="POST">
                @csrf
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-primary" id="add-password">Change Password</button>
...
@section('js')
    ...
    <script type="text/javascript">
        $("#add-password").click(function() {
            $("#edit-form").append(
                '<div class="form-group"><label for="exampleInputPassword1">Password</label><input type="password" class="form-control" name="password" id="exampleInputPassword1" placeholder="New Password"></div><div class="form-group"><label for="exampleInputConfirmPassword1">Confirm Password</label><input type="password" class="form-control" id="exampleInputConfirmPassword1" name="password_confirm" placeholder="Confirm Password"></div>'
            );
        });
    </script>
@stop
